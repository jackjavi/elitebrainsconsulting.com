...
const Header = () => {
  ...
  return (
    <header className="bg-gray-500 bg-opacity-50 p-6 h-20 md:h-32 lg:h-40 2xl:h-48 w-full z-50 bg-[url('http://res.cloudinary.com/popit/image/upload/v1742494206/h2mvghzwdt0rbx0p1rzw.jpg')] bg-cover bg-center bg-no-repeat">
